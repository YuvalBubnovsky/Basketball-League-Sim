...
void Game::play_game() {
    ...
    this->get_home_team()->setPointsFor(this->get_home_team()->getPointsFor() + this->get_home_team_score());
    this->get_away_team()->setPointsAgainst(this->get_away_team()->getPointsAgainst() + this->get_home_team_score());
    this->set_away_team_score(
            50 + (rand() % 45) + this->get_away_team()->getSkill() * 10); // will generate a number between 50 and 100
    this->get_away_team()->setPointsFor(this->get_away_team()->getPointsFor() + this->get_away_team_score());
    this->get_home_team()->setPointsAgainst(this->get_home_team()->getPointsAgainst() + this->get_away_team_score());
    get_winner();
}
